...
PARAMETER {
	gnabar	= 0.12  	(mho/cm2)	: maximum conductance
	vshift	= -10		(mV)		: voltage shift (affects all)
								
	tha 	= -35		(mV)		: v 1/2 for activation
	qa  	= 9			(mV)		: activation slope		
	Ra  	= 0.182		(/ms)		: open (v)		
	Rb   	= 0.124		(/ms)		: close (v)		

	thi1	= -50		(mV)		: v 1/2 for inactivation 	
	thi2 	= -75		(mV)		: v 1/2 for inactivation 	
	qi 		= 5			(mV)	    : inactivation tau slope
	thinf	= -65		(mV)		: inactivation inf slope	
	qinf	= 6.2		(mV)		: inactivation inf slope
	Rg 		= 0.0091	(/ms)		: inactivation (v)	
	Rd 		= 0.024		(/ms)		: inactivation recovery (v) 
